      ...
      <footer className='bg-dark-subtle mt-5 mt-5'>
        <div className="d-lg-flex justify-content-between">
          <ul type='none' className='col-lg-3 py-3'>
            ...
            <li className='fs-5 py-1'><i className="bi bi-geo-fill text-primary fs-4 mx-2"></i><span>Pulchowk, Lalitpur</span></li>
            <li className='fs-5 py-1'><i className="bi bi-envelope-fill text-primary fs-4 mx-2"></i><span>someone@gmail.com</span></li>
            <li className='fs-5 py-1'><i className="bi bi-telephone-plus-fill text-primary fs-4 mx-2"></i> +977-9800000000</li>
            <li className='fs-5 py-1'><i className="bi bi-info-circle-fill text-primary fs-4 mx-2"></i><span>info@company.com</span></li>
          </ul>
          ...
          <ul type='none' className=' col-lg-4 py-3 pe-5'>
